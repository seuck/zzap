...
var map = {
	"./content.js": 9,
	"./jquery.lazyload.min.js": 10,
	"./jquery.mousestop.js": 11,
	"./jquery.url.js": 12,
	"./scans.js": 13,
	"./scroll.js": 14
};
...
var _ContentContainer = __webpack_require__(15);

var _ContentContainer2 = _interopRequireDefault(_ContentContainer);

var _ContentSection = __webpack_require__(16);
...
exports.default = {
  name: 'app',
  components: { ContentContainer: _ContentContainer2.default, ContentSection: _ContentSection2.default },
  data: function data() {
    return {
      magazine: {}
    };
  ...
  methods: {
    getMagazine: function getMagazine() {
      ...
      axios.get('api/magazines.js').then(function (response) {
 ...
 */
(function (a, b) {
  var c = a(b);a.fn.lazyload = function (d) {
    function h() {
      var b = 0;e.each(function () {
        var c = a(this);if (g.skip_invisible && !c.is(":visible")) return;if (!a.abovethetop(this, g) && !a.leftofbegin(this, g)) if (!a.belowthefold(this, g) && !a.rightoffold(this, g)) c.trigger("appear");else if (++b > g.failure_limit) return !1;
      });
    }var e = this,
        f,
        g = { threshold: 0, failure_limit: 0, event: "scroll", effect: "show", container: b, data_attribute: "original", skip_invisible: !0, appear: null, load: null };return d && (undefined !== d.failurelimit && (d.failure_limit = d.failurelimit, delete d.failurelimit), undefined !== d.effectspeed && (d.effect_speed = d.effectspeed, delete d.effectspeed), a.extend(g, d)), f = g.container === undefined || g.container === b ? c : a(g.container), 0 === g.event.indexOf("scroll") && f.bind(g.event, function (a) {
      return h();
    }), this.each(function () {
      var b = this,
          c = a(b);b.loaded = !1, c.one("appear", function () {
        if (!this.loaded) {
          if (g.appear) {
            var d = e.length;g.appear.call(b, d, g);
          }a("<img />").bind("load", function () {
            c.hide().attr("src", c.data(g.data_attribute))[g.effect](g.effect_speed), b.loaded = !0;var d = a.grep(e, function (a) {
              return !a.loaded;
            });e = a(d);if (g.load) {
              var f = e.length;g.load.call(b, f, g);
            }
    ...
    var f;return e.container === undefined || e.container === b ? f = c.height() + c.scrollTop() : f = a(e.container).offset().top + a(e.container).height(), f <= a(d).offset().top - e.threshold;
  }, a.rightoffold = function (d, e) {
    var f;return e.container === undefined || e.container === b ? f = c.width() + c.scrollLeft() : f = a(e.container).offset().left + a(e.container).width(), f <= a(d).offset().left - e.threshold;
  }, a.abovethetop = function (d, e) {
    var f;return e.container === undefined || e.container === b ? f = c.scrollTop() : f = a(e.container).offset().top, f >= a(d).offset().top + e.threshold + a(d).height();
  }, a.leftofbegin = function (d, e) {
    var f;return e.container === undefined || e.container === b ? f = c.scrollLeft() : f = a(e.container).offset().left, f >= a(d).offset().left + e.threshold + a(d).width();
    ...
    $.url = function (url, strictMode) {
        ...
        return {
            ...
            attr: function attr(_attr) {
                ...
                return _attr !== undefined ? this.data.attr[_attr] : this.data.attr;
            },

            // return query string parameters
            param: function param(_param) {
                return _param !== undefined ? this.data.param.query[_param] : this.data.param.query;
            },
...
(function () {
	...
	var initScans = function initScans() {
		...
		(0, _jquery2.default)("#reader_content").mousestop(function () {
			(0, _jquery2.default)("#reader_navigator").fadeOut('fast');
		});
		...
		loadScansFromParams(_jquery2.default.url().param("issue"), _jquery2.default.url().param("volume_page"));
	};

	var readSemanticURLParams = function readSemanticURLParams() {
		var numeric_params = [];
		var url_parts = _jquery2.default.url().data.attr.relative.split('/');
	...
	var loadScansFromParams = function loadScansFromParams(request_issue, request_volume_page) {
	...
	var renderIssue = function renderIssue() {
		...
		(0, _jquery2.default)("#_" + partial).show();
	...
	var renderScanAuthors = function renderScanAuthors() {
		var partialRendered; // counter used for incremental id values
		var partial; // name of the partial without heading underscore
	...
	var showReader = function showReader(page) {
		var pages = {};
		if (page % 2 == 0) {
	...
	var callReader = function callReader(event) {
		renderReader(event.data);
	};

	// Show and initialiaze Reader
	var renderReader = function renderReader(data) {
		...
		(0, _jquery2.default)("#reader_content").removeClass("double");
		(0, _jquery2.default)("#reader_left").off("load");
		(0, _jquery2.default)("#reader_right").off("load");

		//Reset Reader position just por single pages to avoid scroll jump on page change
		if (isCover || isBackcover) {
			(0, _jquery2.default)("#reader_content").css("margin-top", 0).css("margin-left", 0);
		...
		// Setup infos
		(0, _jquery2.default)("#reader_info_magazine").html("<strong>Zzap!</strong> numero " + issueData.sequence + " - " + locales.months[issueData.month - 1] + " " + issueData.year);

		// Setup new images
		if (!isCover) {
			(0, _jquery2.default)("#reader_left").on('load', function () {
				loaderUnload();
			});
			(0, _jquery2.default)("#reader_left").attr("src", pages_path + issueData.volumes[0].pages[data.l].scan.path).on("click", { "l": data.l - 2, "r": data.r - 2 }, callReader).show();
		}
		if (!isBackcover) {
			(0, _jquery2.default)("#reader_right").on('load', function () {
				loaderUnload();
			});
			(0, _jquery2.default)("#reader_right").attr("src", pages_path + issueData.volumes[0].pages[data.r].scan.path).on("click", { "l": data.l + 2, "r": data.r + 2 }, callReader).show();
		}

		// Set two page visualization if needed and pages number/name
		if (isCover) {
			(0, _jquery2.default)("#reader_info_pages").html("Copertina");
		} else if (isBackcover) {
			(0, _jquery2.default)("#reader_info_pages").html("Quarta di copertina");
		} else {
			(0, _jquery2.default)("#reader_content").addClass("double");
			(0, _jquery2.default)("#reader_info_pages").html(issueData.volumes[0].pages[data.l].label + " - " + issueData.volumes[0].pages[data.r].label);
		}
	...
	// Reader close event
	var closeReader = function closeReader() {
		// If Issue wasn't rendered
		if ((0, _jquery2.default)("#double_pages_generated").children().length == 0) {
			renderIssue();
		}
		(0, _jquery2.default)("#reader").hide();
		(0, _jquery2.default)(".scans__issue").show();
	...
	var readerKeyboardEventHandler = function readerKeyboardEventHandler(e) {
		if ((0, _jquery2.default)("#reader").is(':visible')) {
			switch (e.which) {
				case 27:
					closeReader(); // esc
					break;
				case 37:
					// left arrow
					(0, _jquery2.default)("#reader_left").trigger("click");
					break;
				case 39:
					// right arrow
					(0, _jquery2.default)("#reader_right").trigger("click");
					break;
			}
		}
	};

	var readerContentScroll = function readerContentScroll(e) {
		//var pageCoords = "( " + e.pageX + ", " + e.pageY + " )";
		//var clientCoords = "( " + e.clientX + ", " + e.clientY + " )";

		(0, _jquery2.default)("#reader_navigator").fadeIn('fast');

		var overflowX = (0, _jquery2.default)("#reader_content").width() - (0, _jquery2.default)(window).width();
		var relativeX = e.clientX - (0, _jquery2.default)(window).width() / 2;

		// Scroll only if content is larger than container
		if (overflowX > 0) {
			if (Math.abs(relativeX * 2) < overflowX / 2) {
				(0, _jquery2.default)("#reader_content").css("margin-left", -(relativeX * 2 + overflowX / 2));
			} else {
				if (relativeX > 0) {
					(0, _jquery2.default)("#reader_content").css("margin-left", -overflowX);
				} else {
					(0, _jquery2.default)("#reader_content").css("margin-left", 0);
				}
			}
		}

		var overflowY = (0, _jquery2.default)("#reader_content").height() - (0, _jquery2.default)(window).height();
		var relativeY = e.clientY - (0, _jquery2.default)(window).height() / 2;

		// Scroll only if content is larger than container
		if (overflowY > 0) {
			if (Math.abs(relativeY * 2) < overflowY / 2) {
				(0, _jquery2.default)("#reader_content").css("margin-top", -(relativeY * 2 + overflowY / 2));
			} else {
				if (relativeY > 0) {
					(0, _jquery2.default)("#reader_content").css("margin-top", -overflowY);
				} else {
					(0, _jquery2.default)("#reader_content").css("margin-top", 0);
				}
			}
		}
	};
