<template>
  <content-container
    ...
    <content-section>
      ...
      <p>Quella che leggerete di seguito, sarà una storia veramente strana.
    ...
    <content-section title="Le origini">
      <content-image
        :image-path="resolveAssetPath(`speciali/leabbiamovistetutte/numero1.jpg`)"
      ...
      "edizione italiana" di quella "inglese più venduta": Zzap!.</p>
      <p>Zzap! uscì in sordina, nel lontano maggio del 1986, tanto in sordina che non tutte
      ...
      cui si saranno abituati in tanti.</p>
      <p>Solo in seguito riuscii a recuperare i sei numeri che mancavano alla mia collezione:
      ...
      lo spedì in regalo.</p>
      <p>Zzap!, all’epoca, aveva tantissimi pregi sul lato contenutistico, ma un sacco di
    ...
    <content-section title="Un &quot;dualismo&quot; persistente" >
      <content-image
        :image-path="resolveAssetPath(`speciali/leabbiamovistetutte/numero14.jpg`)"
    ...
    <content-section title="La fine degli anni '80, e il declino degli 8 bit">
      <content-image
        :image-path="resolveAssetPath(`speciali/leabbiamovistetutte/numero33.jpg`)"
      ...
      <content-image
        :image-path="resolveAssetPath(`speciali/leabbiamovistetutte/numero43.jpg`)"
        caption="La splendida protagonista di &quot;Insects is Space&quot; creata da Sensible
          Software"
        align="right"
        rotation="cw"
      />
    ...
    <content-section title="1993: l'anno di TGM">
      ...
      <content-image
        :image-path="resolveAssetPath(`speciali/leabbiamovistetutte/numero74.jpg`)"
