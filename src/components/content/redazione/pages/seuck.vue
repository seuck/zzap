<template>
  <content-container
    ...
    <p>
      <content-image
        :image-path="resolveAssetPath(`redazione/seuck/seuck.gif`)"
        align="right"
        rotation="cw"
      />
      ...
      Attivo nella &quot;demo scene&quot; locale, smanetta con gli interrupts e i raster del
      VIC II.<br>
      L'omonimo programma, S.E.U.C.K, gli apre le porte della pixel art, che gli frutterà più tardi,
      ai tempi dell'Amiga, una proposta di lavoro da Ivan Venturi. Sceglie di continuare gli studi
      universitari.<br>
      Si fa carico della web di Zzap.it già nel 2004 ed è l'autore della versione che leggete
      adesso.</p>
