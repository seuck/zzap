webpackJsonp([ 3 ], {
    ...
    function(e, i, a) {
        ...
        var s = false;
        var r = a(0);
        var l = r(t.a, n["a"], false, null, null, null);
        ...
        if (false) !function() {
            ...
            e.hot.accept();
            if (!e.hot.data) i.createRecord("data-v-fa07ae3a", l.options); else i.reload("data-v-fa07ae3a", l.options);
    ...
    function(e, i, a) {
        ...
        var o = function() {
            ...
            }, [ a("content-section", [ a("content-image", {
                attrs: {
            ...
            }), e._v("\n        Ma purtroppo la console non vide mai la luce a parte forse qualche esemplare dimostrativo per una serie di motivi fra i quali i continui cambiamenti dell'hardware e i continui posticipi della data di uscita che scoraggiarono le software house dall'investire risorse sullo sviluppo per questa macchina. Ad esempio la memoria ram dela consolle doveva essere inizialmente di 128k per poi essere portata a 256k con la possibilità di espansione fino a 512k dopo le critiche subite da parte di alcune software house, quindi ai definitivi 512k negli ultimi modelli.") ], 1), e._v(" "), a("p", [ e._v("Vediamo dunque le specifiche tecniche della console:\n        "), a("ol", [ a("li", [ e._v("Il "), a("strong", [ e._v("processore") ]), e._v(" era un 8086 a 16 bit affiancato da un coprocessore custom ASIC a 12mhz comprendente video generator, colour palette, disk controller, Blitter, ROM, fast RAM, 12 MIP Arithmetic and Logic Unit, RISC Digital Signal Processor, stereo compact disk DACs and digital and analogue ports.") ]), e._v(" "), a("li", [ e._v("La "), a("strong", [ e._v("memoria") ]), e._v(" ram come già detto era di 256k (512k successivamente).") ]), e._v(" "), a("li", [ e._v("Le "), a("strong", [ e._v("risoluzioni") ]), e._v(" grafiche 256x200 a 256 colori, 256x200 a 16 colori e 512x200 a 16 colori il tutto da una paletta di 4096 colori.") ]), e._v(" "), a("li", [ e._v("Il "), a("strong", [ e._v("sonoro") ]), e._v(" stereo a 25 canali con qualità CD ed output via TV o cuffie.") ]), e._v(" "), a("li", [ a("strong", [ e._v("Uscite video") ]), e._v(" standard Tv o RGB composito.") ]), e._v(" "), a("li", [ e._v("Il "), a("strong", [ e._v("software") ]), e._v(" risiedeva su dischetti da 3,5 con capacità da 880k o su cartuccia.") ]) ]), e._v("\n        Dopo il fallimento del Konix multisystem e lo scioglimento delle due società la Flare continuò lo sviluppo dell'hardware del Flare One producendo il Flare Two che fu poi venduto ad Atari e diventò l'"), a("strong", [ e._v("Atari Jaguar") ]), e._v(".\n      ") ]) ], 1) ], 1);
        };
        var t = [];
        ...
        if (false) {
            e.hot.accept();
            if (e.hot.data) require("vue-hot-reload-api").rerender("data-v-fa07ae3a", n);
        }
    }
});