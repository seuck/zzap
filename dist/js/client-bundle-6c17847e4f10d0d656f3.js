webpackJsonp([ 5 ], {
    ...
    function(e, i, a) {
        ...
        var r = false;
        var l = a(0);
        var s = l(n.a, t["a"], null, null, null);
        s.options.__file = "src/components/content/diaries/pages/zzap.vue";
        if (s.esModule && Object.keys(s.esModule).some(function(e) {
            return "default" !== e && "__" !== e.substr(0, 2);
        })) console.error("named exports are not supported in *.vue files.");
        if (s.options.functional) console.error("[vue-loader] zzap.vue: functional components are not supported with templates, they should use render functions.");
        /* hot reload */
        if (false) !function() {
            ...
            e.hot.accept();
            if (!e.hot.data) i.createRecord("data-v-eb8093d0", s.options); else i.reload("data-v-eb8093d0", s.options);
    ...
    function(e, i, a) {
        ...
        var o = function() {
            ...
            }) ]), e._v(" "), a("p", [ e._v("Scrivo queste righe proprio per raccontare la tappa successiva che sta per raggiungere il sito web del Progetto Zzap! Italia.") ]) ]), e._v(" "), a("content-section", {
                attrs: {
        ...
        if (false) {
            e.hot.accept();
            if (e.hot.data) require("vue-hot-reload-api").rerender("data-v-eb8093d0", t);
        }
    }
});